...
public class BuoyancyEdit : MonoBehaviour
{
    //	public Ocean ocean;
    ...
    private bool recalibrationNeeded = false;
    ...
    private void Recalibrate()
    {
        ...
        Debug.Log(string.Format("<color=blue>[Buoyancy.cs]</color> Name=\"{0}\" volume={1:0.0}, mass={2:0.0}, density={3:0.0}", name, volume, GetComponent<Rigidbody>().mass, density));
    }
